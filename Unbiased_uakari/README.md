...
### Without compose
```
docker run --name postgis -p 5432:5432 geographica/postgis:unbiased_uakari
```
...
docker run --rm -ti -v /home/malkab/Desktop/:/d --link test_07:pg \ geographica/postgis: \ PGPASSWORD="new_password_here" psql -h pg -p 5432 -U postgres postgres
```
